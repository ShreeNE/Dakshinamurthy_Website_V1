...
import { X, Sparkles, BookOpen, Compass, ArrowRight, Play, Square, RefreshCcw } from "lucide-react";
...
export default function DomainExpandedModal({
  ...
  const [activeTab, setActiveTab] = useState<"teachings" | "practice" | "gallery">("teachings");
